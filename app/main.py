"""
Entry point for the AI Wardrobe Recommendation System.
...
from app.routes import user_routes, clothing_routes, recommendation_routes
...
def create_app() -> FastAPI:
    ...
    # Enable CORS so the frontend (Lovable/React) can call the API
